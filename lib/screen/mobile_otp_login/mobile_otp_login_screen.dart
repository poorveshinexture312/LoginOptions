...
import 'mobile_otp_login_controller.dart';
...
class _MobileOtpLoginScreenState extends State<MobileOtpLoginScreen> {
  final MobileOtpLoginController controller = Get.put(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              " *",
                              style: style600S16.copyWith(color: AppColor.black),
                            ),
                          ],
                        ),
                        ...
                        CommonTextField(
                          ...
                          suffixImg: controller.errorPhoneNumber.value
                              ? AssetRes.errorTagImg
                              : null,
                          onChanged: controller.onchangePhoneFun,
                          inputFormatters: [
