...
import 'mobile_password_login_controller.dart';

class MobilePasswordLoginScreen extends StatelessWidget {
  MobilePasswordLoginScreen({Key? key}) : super(key: key);

  final MobilePasswordLoginController controller = Get.put(
        ...
        children: [
          SingleChildScrollView(
            ...
            child: SizedBox(
              height: 100.h,
              child: SafeArea(
                child: GetBuilder<MobilePasswordLoginController>(
                  id: 'login',
                  builder: (context) {
                    return Padding(
                        ...
                        children: [
                          ...
                          CommonTextField(
                            ...
                            suffixImg: controller.numberBool
                                ? AssetRes.errorTagImg
                                : null,
                            onChanged: controller.onNumberChange,
                            inputFormatters: [
